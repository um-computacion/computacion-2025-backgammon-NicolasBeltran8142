...
def draw_side_panel(screen, font, game):
    ...
    if game:
        ...
        draw_text(
            screen, f"White: {p1.nombre}", font, FONT_COLOR, PANEL_WIDTH // 2, 150
        )
        draw_text(
            screen, f"Black: {p2.nombre}", font, FONT_COLOR, PANEL_WIDTH // 2, 200
        )
...
def draw_dice_and_moves(screen, font, game):
    if game.last_roll:
        ...
        draw_text(
            screen,
            f"{game.last_roll[0]} & {game.last_roll[1]}",
            font,
            (0, 0, 255),
            150,
            600,
        ...
        for event in pygame.event.get():
            ...
            if game_state == START_SCREEN:
                ...
                if event.type == pygame.KEYDOWN and active_box:
                    name_ptr = (
                        player1_name if active_box == input_box1 else player2_name
                    )
                ...
                if event.type == pygame.MOUSEBUTTONDOWN:
                    ...
                    if roll_dice_button.collidepoint(pos) and not dice_rolled:
                        ...
                        if (
                            ...
                            and clicked_dest in possible_moves
                        ):
                            ...
                            if (
                                ...
                                and game.board._puntos_[clicked_dest][-1]._color_
                                == color
                            ):
