...
def _get_visual_column(point_index):
    ...
    if 6 <= point_index <= 11: return 11 - (point_index - 6) - 1
...
def draw_board(screen):
    ...
    for i in range(12):
        ...
        color_top = POINT_GOLD if point_1_index % 2 != 0 else POINT_BLACK
        ...
        color_bottom = POINT_GOLD if point_2_index % 2 != 0 else POINT_BLACK
        ...
        for event in pygame.event.get():
            ...
            if game_state == START_SCREEN:
                if event.type == pygame.MOUSEBUTTONDOWN:
                    if input_box1.collidepoint(event.pos): active_box = input_box1
                    elif input_box2.collidepoint(event.pos): active_box = input_box2
                ...
                if event.type == pygame.MOUSEBUTTONDOWN:
                    ...
                    if roll_dice_button.collidepoint(pos) and not dice_rolled:
                        ...
                        if selected_point is not None and clicked_dest in possible_moves:
                            ...
                            if clicked_dest != "off" and game.board._puntos_[clicked_dest] and game.board._puntos_[clicked_dest][-1]._color_ == color:
                                selected_point = clicked_dest
                                possible_moves = []
                                for move in set(game.available_moves):
                                    dest = selected_point - move if color == "blanco" else selected_point + move
